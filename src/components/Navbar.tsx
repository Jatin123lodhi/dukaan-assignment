...
const Navbar = () => {
  return (
    <div className="w-[224px] min-h-full p-4 px-[10px] bg-blue-secondary text-white font-inter ">
      <div className="flex flex-col justify-between h-full">
        ...
        <div>
          {/* credits */}
          <div className="flex gap-3 items-center px-[12px] py-[6px] bg-[#353C53] rounded-[4px]  ">
